...
// Added AnimatePresence to the imports below
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative group max-w-4xl mx-auto">
          ...
          <div className="relative bg-zinc-900/50 rounded-2xl border border-white/5 shadow-2xl overflow-hidden">
            ...
            <div className="absolute bottom-0 inset-x-0 p-4 bg-gradient-to-t from-black/80 to-transparent flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity z-20">
              ...
              <div className="text-[9px] font-bold uppercase tracking-widest text-zinc-400 bg-black/40 px-2 py-1 rounded border border-white/5">
                Quantora Guide
              </div>
            </div>
          </div>
