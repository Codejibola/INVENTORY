...
export const createProduct = async (userId, name, price, stock, category, selling_price = 0, barcode = null) => {
  await pool.query(
    "INSERT INTO products (user_id, name, price, units, category, selling_price, barcode) VALUES ($1, $2, $3, $4, $5, $6, $7)",
    [userId, name, price, stock, category, selling_price, barcode]
  );
  return { message: "Product created" };
};

// Update product including selling_price
export const updateProduct = async (id, userId, name, price, stock, category, selling_price, barcode) => {
  await pool.query(
    "UPDATE products SET name = $1, price = $2, units = $3, category = $4, selling_price = $5, barcode = $6 WHERE id = $7 AND user_id = $8",
    [name, price, stock, category, selling_price, barcode, id, userId]
  );
